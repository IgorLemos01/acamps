            ...
            <Card className="p-8 bg-card shadow-brand animate-slide-up">
              <div className="text-center mb-8">
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-xl p-6 mb-4">
                  <p className="text-2xl font-mono font-bold text-card-foreground break-all">
                    {pixKey}
                  </p>
                </div>
                ...
                <Button
                  ...
                  className="w-full bg-gradient-brand hover:bg-gradient-secondary text-foreground font-bold py-4 text-lg shadow-brand transition-all duration-300 hover:shadow-glow hover:scale-105 mb-6"
                >
              ...
              <div className="bg-secondary/10 backdrop-blur-sm border border-secondary/20 rounded-xl p-6 mb-6">
                <p className="text-card-foreground text-center font-semibold mb-4">
