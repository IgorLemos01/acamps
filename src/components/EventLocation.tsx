...
const EventLocation = () => {
  return (
    <section id="evento" className="py-20 bg-card">
          ...
          <div className="animate-fade-in">
            <Card className="p-4 shadow-brand">
              <div className="aspect-video rounded-lg overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3656.853950367623!2d-46.73549938556713!3d-23.565376784692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce5755ea608b47%3A0xf2d061bb5c5b8e94!2sSão Paulo - SP!5e0!3m2!1spt!2sbr!4v1234567890123"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
