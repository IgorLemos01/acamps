      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-foreground/80 max-w-2xl mx-auto animate-slide-up">
            Equipamentos de alta qualidade para sua aventura
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            <Card 
              key={product.id} 
              className="overflow-hidden bg-card shadow-brand hover:shadow-glow transition-all duration-300 hover:scale-105 group animate-fade-in"
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="bg-accent hover:bg-accent/90 text-accent-foreground shadow-glow hover:shadow-brand transition-all duration-300"
                  >
        ...
        <div className="text-center mt-12">
          <Button 
            size="lg"
            className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-bold text-lg px-8 py-4 rounded-full shadow-glow hover:shadow-brand transition-all duration-300 hover:scale-105"
            onClick={() => handleWhatsAppContact('todos os produtos')}
          >
